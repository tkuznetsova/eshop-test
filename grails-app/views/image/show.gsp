	...
	<body>
		...
		<div id="show-image" class="content scaffold-show" role="main">
			...
			<ol class="property-list image">
				...
				<g:if test="${imageInstance?.goodId}">
				<li class="fieldcontain">
					<span id="goodId-label" class="property-label"><g:message code="image.goodId.label" default="Good Id" /></span>
					
						<span class="property-value" aria-labelledby="goodId-label"><g:fieldValue bean="${imageInstance}" field="goodId"/></span>
